...
import eventServers.EventStream;
...
public class StreamAvroProducer {

    private final static Logger LOG = LoggerFactory.getLogger(StreamAvroProducer.class);
    ...
    public static void main(String[] args) {
        ...
        try (KafkaProducer<String, LogEvent> kProducer = new KafkaProducer<>(props)) {
            EventStream.getEvent().forEach(logEvent ->
